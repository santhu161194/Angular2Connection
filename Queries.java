...
public class Queries {
	...
	public static String getAllEmployees = "select * from AssetManagement.tbl_employee";
	...
	public static String getAllRoles = "select * from AssetManagement.tbl_role";
	...
	public static String autheticate = "select * from AssetManagement.tbl_employee where employeeId=? and Password=?";
	...
	// Asset
	public static String getAllAssetRequests = "select * from AssetManagement.tbl_asset_request";

	public static String getEmployeeAsset = "select a.* from AssetManagement.tbl_asset  a inner join AssetManagement.tbl_asset_mapping am on a.AssetId=am.AssetId where am.AssignedTo=?";

	public static String getAssetByStatus = "select * from AssetManagement.tbl_asset where Status=?";
	
	public static String getAsset = "select * from AssetManagement.tbl_asset where assetId=?";
	
	public static String getAllAsset = "select * from AssetManagement.tbl_asset";
	
	public static String getAssetRequestsByEmployee = "select * from AssetManagement.tbl_asset_request where EmployeeId=?";
	...
	public static String getNewAssetTypeRequest = "select * from AssetManagement.tbl_asset_request_unavailable ";
	...
	// log asset-mapping
	public static String getAssetMapping = "select * from AssetManagement.tbl_asset_mapping where AssetId=?";
	public static String UPDATE_ASSET_MAPPING_TO_LOG = "insert into AssetManagement.tbl_asset_mapping_log values(?,?,?,?,?,?)";

	public static String getAssetByType="";

	public static String updateAsset="update AssetManagement.tbl_asset set SerialNumber=?,AssetName=?,Cost=? where AssetId=?";
